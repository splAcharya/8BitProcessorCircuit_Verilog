...
HD_PWD='D:/BitBucketLocalRepository/verilog-projects/8_Bit_Processor/8Bit_uC/8Bit_uC.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uC_8Bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uC_8Bit.tcl
